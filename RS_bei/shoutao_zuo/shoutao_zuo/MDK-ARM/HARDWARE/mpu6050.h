...
#define CMD_FORWARD   	0x29  // 向前			手势3，上面的按键
#define CMD_BACKWARD    0x2A  // 向后			手势3，下面的按键

#define CMD_ROBOTMODE  0x21  // 机器人
#define CMD_CARMODE    0x22  // 小车
#define CMD_NONE    0x00  // 无指令

#define CMD_ANJIAN_SHIJUE 	0x64			//手指比1，下面的按键  //检测1 手势1
#define CMD_KAIGUAN_SHIJUE  0x65			//手指比2，下					 //检测2 手势2
#define CMD_ANJIAN_DONGZUO   0x09			//手指比1，上面的按键	 //动作1 手势3
#define CMD_KAIGUAN_DONGZUO  0x2D			//手指比2，上
