...
/* Actual period: 0.01 seconds. Actual duty: 50%. */.period_counts = (uint32_t) 0xf424,
  .duty_cycle_counts = 0x7a12, .source_div = (timer_source_div_t) 3, .channel = 0, .p_callback = timer0_callback,
...
{ .p_ctrl = &g_timer_agt0_ctrl, .p_cfg = &g_timer_agt0_cfg, .p_api = &g_timer_on_agt };
